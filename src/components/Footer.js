    ...
    <footer className="max-w-6xl mx-auto px-6 py-4 my-4">
      ...
      <div className="flex flex-col-reverse border-t gap-3 border-gray-300 dark:border-gray-500  pt-8 sm:flex-row sm:justify-between">
        <div className="text-gray-500 flex justify-center">
          <small className="m-auto mt-4">© {new Date().getFullYear()} Hecho con ❤️ por Marlon Acosta</small>
        </div>
        <div className="flex gap-6  justify-center">
          {socialMedia.map((social) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-zinc-800 hover:text-zinc-700 dark:text-zinc-500 dark:hover:text-white transition-all duration-700 ease-out"
            >
